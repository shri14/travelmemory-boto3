...
instance_name = 'travalFE'  # Replace with the instance name you're searching for
...
ami_name = f'shriFEAMI-{timestamp}'
print(instance_id)
...
launch_template_name = 'traval-FE-Launch-Template'
cpu_utilization_target = 50
load_balancer_name = 'Traval-load-balancer'
...
target_group_arn = 'traval-target-group'

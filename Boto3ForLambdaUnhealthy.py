...
function_name = 'traval-hBoto3LambdaFuntion'
role_arn = 'arn:aws:iam::295397358094:role/service-role/traval-LambdaBasedHealthChecks-role-a9vi6y8e'  # Replace with your existing IAM role ARN
...
response1 = lambda_client.add_permission(
    FunctionName='traval-Boto3LambdaFuntion',
